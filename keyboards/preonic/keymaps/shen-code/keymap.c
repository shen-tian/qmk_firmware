...
[_LOWER] = {
  ...
  {_______, _______, KC_UP,   _______, KC_MS_U, KC_BTN1, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______},
  {_______, KC_LEFT, KC_DOWN, KC_RGHT, KC_MS_L, KC_MS_R, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, _______},
  {_______, _______, _______, _______, KC_MS_D, _______, _______, _______, _______, _______, _______, _______},
